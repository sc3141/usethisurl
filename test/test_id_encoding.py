...
class TestEncode(TestCase):
    ...
    def test_max_int(self):
        self.assertEquals('F=-g', id_encoding.encode(id_encoding.MAX_ID))
...
class TestValidate(TestCase):
    ...
    def test_accept_max_int(self):
        x = id_encoding.check_encoding(id_encoding.encode(id_encoding.MAX_ID))
...
class TestCreateShortIdMap(TestCase):
    ...
    def test_accept_all_valid(self):
        m = id_encoding.create_short_id_map('short', 'submit', 'waka')
